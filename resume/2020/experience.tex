...
\begin{itemize}
  ...
  %\item Tech Lead for Cross Platform User Privacy and Regulations - handling 400m+ impressions daily. Decreased error rates by 30\%+ through code-quality and simplification.
...
\begin{comment}
  ...
  \begin{itemize}
    ...
    %\item Recruited, hired and coached new hires, while performing hundreds of interviews and phone-screens.
    %\item Adviser to multiple 8+ engineer teams as part of Googles Tech Immersion program. 
  \end{itemize}
\end{comment}
