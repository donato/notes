...
\begin{flushleft}
 ...
 %    \textbf{The Elusive Video Metric} \hfill July 2017\\
  %  A talk at the Video Tech NYC meetup on identifying the quality of video content, independent from number of plays or likes it's received. Attended by over 100 developers.
  %\vspace{10pt}

  %  \textbf{Agile Incident Response for Big Data Systems} \hfill December  2016\\
    %An article on how data teams can increase uptime while decreasing engineers stress by carefully aligning incentive systems and roles, published by JW Player.
...
%    Founder of a non-profit group, partnered with FairVote, to bring Ranked Choice Voting to New York State.
\end{flushleft}
