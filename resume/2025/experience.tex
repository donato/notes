...
\experiencelist{
  \item Led the Google Ad Manager response to Privacy Sandbox for video,
  ...
  \item Created a 'Zero-Latency' roadmap for video advertising through
      full-stack technical design and implementation. Initial results have a
      realized impact of 70\% on key Connected-TV segments.
  ...
  \item Created and led a task force to improve fraud detection on CTV while
      improving inventory access, across 4 product areas.
}
        

\textsc{SciFi Enthusiast\hfill Formative Years - Present\\}
\textsc{Public Libraries\hfill New York, NY\\}
\experiencelist{
  ...
  \item My current project is a language learning app, which simulates being
      part of a study group using multiple agents with independent traits and
      daily "experiences".
...
\experiencelist{
  \item Drove development of 16 binaries, responsible for xx trillion ad requests/year and 3x growth in impressions in my tenure.
...
\textsc{Senior Software Engineer\hfill Feb 2018 - Mar 2021\\}
\textsc{Google \hfill New York, NY\\}
\experiencelist{
  \item Designed and implemented a solution (Trustless GAIA) to bring Google-signed-in personalization to video advertising on Android.

  \item Due to good performance and handling of user-privacy it has been generalized and expanded to solve for gBid (2023), AdMob (2023), GoogleTV (2024) and Waze (2025).
...
\textsc{Engineering Manager\hfill Apr 2016 - Jan 2018\\}
...
\textsc{Senior Software Engineer\hfill May 2014 - Apr 2016\\}
\textsc{JW Player \hfill New York, NY\\}
\experiencelist{
...
\textsc{Software Engineer\hfill Jun 2012 - Apr 2014\\}
...
\textsc{Research Fellowship with Xerox\hfill Jun 2011 - May 2012\\}
